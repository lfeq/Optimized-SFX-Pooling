...
namespace AudioSystem {
    public static class AudioExtensions {
        ...
        /// </summary>
        public static float toLogarithmicVolume(this float t_sliderValue) {
            return Mathf.Log10(Mathf.Max(t_sliderValue, 0.0001f)) * 20;
        }
        ...
        /// </summary>
        public static float toLogarithmicFraction(this float t_fraction) {
            return Mathf.Log10(1 + 9 * t_fraction) / Mathf.Log10(10);
        }
    }
}